...
MyLast (1–2 student, i) – Scriet, i un program (script) shell care emuleaza comportamentul
comenzilor last/lastb folosind in acest sens continutul fisierului /var/log/auth.log[1-4]
(Atentie: nu /var/log/wtmp sau /var/log/btmp care sunt fisiere binare). Implementarea tre�buie sa suporte minimal comportamentul comenzilor last/lastb indus de folosirea flag-urilor
