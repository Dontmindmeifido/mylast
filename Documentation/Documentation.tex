...
Scriptul definește o variabilă \texttt{SYSLOG} (\texttt{/var/log}) ce stochează locația system log-urile. În continuare, următoarele fișiere sunt concatenate într-un singur string, care este redirectat spre funcțiile de bază \texttt{mylast/mylastb}:
