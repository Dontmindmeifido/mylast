...
Foloseste comanda built-in "for" pentru a determina numarul de linii intr-un string delimitat prin spatii. \\ Foloseste la parcurgerea variabilelor \textbf{Queue} si \textbf{Session}.
